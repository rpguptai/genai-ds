...
app = FastAPI(
    title="RAG Model API with LangChain and Ollama",
    description="API for a Retrieval-Augmented Generation (RAG) model using local LLMs via Ollama and LangChain, supporting multiple PDF documents.",
    version="1.0.0",
)
...
def process_documents_task(file_paths: List[str]):
    try:
        ...
        # Get the service instance to use in the background task
...
if __name__ == "__main__":
    # Initial document processing on startup
